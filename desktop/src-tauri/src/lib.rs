...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_about,
            commands::peer_profile,
            commands::peer_avatar,
            commands::remote_avatars_enabled,
            commands::set_remote_avatars_enabled,
            ...
            commands::attention_summary,
            commands::doom_apps,
            commands::set_doom_apps,
            ...
            commands::import_saves,
            commands::open_saved_item,
            commands::delete_saved_item,
            commands::reading,
            commands::set_reading_position,
            commands::close_reading,
            commands::stretch_routines,
            commands::stretch_step_at,
            commands::suggested_stretch_routine,
            commands::stretch_break_marks,
            commands::stretch_break_due,
