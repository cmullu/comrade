...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::threads,
            commands::thread,
            commands::thread_root,
            commands::create_topic,
            commands::assign_thread,
            commands::set_topic_closed,
            ...
            commands::stretch_routine,
            commands::save_read,
            commands::saved_reads,
            commands::open_saved_read,
            commands::set_saved_read_position,
            commands::delete_saved_read,
